...
// static const char htmlAntes[] PROGMEM = "<!DOCTYPE html><html lang=\"en\"><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><title>Explosive Letters</title><style>body { font-family: Arial, sans-serif; background-color: #333; color: #fff; display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0; } .container { text-align: center; background: #222; padding: 20px; border-radius: 8px; box-shadow: 0 0 20px rgba(255, 0, 0, 0.5); } h1 { color: #ffcc00; font-size: 2.5em; margin-bottom: 20px; } p { color: #ffcc00; font-size: 1.2em; } .button-container { margin-top: 20px; } .start-button { background-color: #ff0000; color: white; padding: 10px 20px; border: none; border-radius: 5px; font-size: 1.2em; cursor: pointer; transition: background-color 0.3s; } .start-button:hover { background-color: #cc0000; }</style></head><body><div class=\"container\"><h1>Explosive Letters</h1><p>Conecte os fios corretos para desativar a bomba!</p>";
// static const char htmlDepois[] PROGMEM = "</div></body></html>\r\n";
...
//   server.send(200, "text/html", "");
//   server.sendContent(htmlAntes);
//   server.sendContent("<div class=\"button-container\"><button class=\"start-button\">Iniciar Jogo</button></div>");
//   server.sendContent(htmlDepois);
// }
...
//   server.send(200, "text/html", "");
//   server.sendContent(htmlAntes);
//   server.sendContent("<div class=\"button-container\"><button class=\"start-button\">Verificar</button></div>");
...
//   server.send(200, "text/html", "");
//   server.sendContent(htmlAntes);
//   server.sendContent("<div class=\"button-container\"><button class=\"start-button\">Tente Novamente</button></div>");
//   server.sendContent(htmlDepois);
// }
...
//   server.send(200, "text/html", "");
//   server.sendContent(htmlAntes);
//   server.sendContent("<div class=\"button-container\"><button class=\"start-button\">Reiniciar</button></div>");
//   server.sendContent(htmlDepois);
// }
